...
template <typename T>
bool is_primitive_type(const TDynamicType<T>& t);

template <typename T>
bool is_constructed_type(const TDynamicType<T>& t);

template <typename T>
bool is_collection_type(const TDynamicType<T>& t);

template <typename T>
bool is_aggregation_type(const TDynamicType<T>& t);
